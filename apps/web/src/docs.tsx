...
export const SEO_FAQ_ITEMS: ReadonlyArray<SeoFaqItem> = [
  ...
  },
  {
    ...
    answer:
      "Yes. Pass workspaces + onWorkspacesChange (TilingWorkspaceSet) instead of layout + onLayoutChange. useTilingWorkspaceTabs, useTilingWorkspaceSetController, WORKSPACE_KEY_BINDINGS, swipe, slide/fade transition, and spring-load tab drop ship on the public API (26.9.3–26.9.9).",
  },
];
...
export const DOCS_GUIDE_TOPICS: ReadonlyArray<DocsGuideTopic> = [
  ...
  },
  {
    ...
    section: "howto",
    summary:
      "Grouping (title-bar group icon, Alt/Opt+click, Alt/Opt+G, or drag a header onto a title bar), splitting (drag a header), and maximizing (Alt+Enter) are built-in, and you can also drive them from code: dispatch group-leaves to fold leaves into a tabbed group, insert-adjacent to split, and toggle-maximize to maximize/restore a leaf. isMultiSelectModifierActive detects the platform multi-select modifier for your own affordances.",
  },
  {
    id: "concepts",
    title: "Concepts",
